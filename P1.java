...
import programs.LitTuple;
import programs.SymTuple;
import programs.Tuple;
...
public class P1 {
	...
	public static void main(String[] args) throws Exception{
		System.out.println("Name: Shardul Ajmera\nRoll no.: TACO22152");
		initializeTables();
	...
	static void pass1() throws Exception {
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("src/programs/input.txt")));
		out_pass1 = new PrintWriter(new FileWriter("src/programs/output_pass1.txt"), true);
		out_pass1.println("Name: Shardul Ajmera\nRoll no.: TACO22152");
		PrintWriter out_symtable = new PrintWriter(new FileWriter("src/programs/symtable.txt"), true);
		PrintWriter out_littable = new PrintWriter(new FileWriter("src/programs/littable.txt"), true);
		String s;
	...
	static void initializeTables() throws Exception {
		...
		String s,mnemonic;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("src/programs/mot.txt")));
